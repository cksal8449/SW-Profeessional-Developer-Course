...
function toggleDrawerMenu() {
  ...
  //  parentNode 속성으로 클릭된 요소의 부모요소를 찾는다.
  const drawerMenu = this.parentNode;
  // toggle은 클래스가 있을 경우 제거, 없는 경우 추가

  // drawer Menu를 open / close
...
// 0 1 2
// forEach를 사용해서 drawerMenuButtonList
// 배열의 각 요소에 대해 반복 해준다.
...
// 사용자가 클릭한 버튼의 부모요소인 drawer-menu의 
// 활성화 상태가 toggle 된다.
