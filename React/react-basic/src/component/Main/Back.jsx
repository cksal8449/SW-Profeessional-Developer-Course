    ...
    <>
      <section className={props.layout}>
        <div className={props.name}>
          ...
          <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Impedit nesciunt blanditiis cumque quibusdam molestias deserunt sed tempora minima possimus odit!</p>
          {
            // html 조건부로 보여줄 떄
            ...
            showBtn && <button onClick={()=>alert('안녕')} button className='front-btn' type='button'>버튼</button>
          }
        </div>
      </section>
    </>
