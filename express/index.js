...
app.get('/info/:id', function(requests, response){
  // params.id : url 파라미터 중 id 값,
  // 'post' collection에서 params.id 값에 해당하는 데이터 찾아오기
  // 데이터 찾을 때 requests.params.id String  => Int 형변환
  // 'post' collection에 _id값이 int기 때문!
...
// /edit.ejs 경로로 접속시 edit.ejs 내용 보여주기
// /edit/:id 
