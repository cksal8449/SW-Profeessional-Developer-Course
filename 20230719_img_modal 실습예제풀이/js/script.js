// open-btn 클릭 시 .modal-box .overlay fade In()
...
// modal-close 클릭 시 .modal-box .overlay fadeOut()
...
$('.modal-list img').click(function(){
  ...
  // .img-modal-box, .overlay를 fadIn()
  $('.img-modal-box').fadeIn();
  $('.overlay').fadeIn();
})


// .img-modal-btn 클릭시 .img-modal-box, .overlay fadeOut()
